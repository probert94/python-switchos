...
class LinkEndpoint(SwitchOSEndpoint):
    ...
    link_paused: List[bool] = field(metadata={"name": ["paus", "i15"], "type": "bool"}, default=None)
    auto_negotiation: List[bool] = field(metadata={"name": ["an", "i02"], "type": "bool"}, default=None)
    speed: List[Speed] = field(metadata={"name": ["spd", "i08"], "type": "option", "options": Speed}, default=None)
    man_speed: List[Speed] = field(metadata={"name": ["spdc", "i05"], "type": "option", "options": Speed}, default=None)
